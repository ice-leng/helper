...
class IdentityCardHelper
{
     ...
     * @return bool
     */
    public function isValid(string $num): bool
    {
        //老身份证长度15位，新身份证长度18位
        $length = strlen($num);
     ...
     * @return bool
     */
    private function isAreaCodeValid(string $area): bool
    {
     ...
     * @return bool
     */
    private function isVerifyCodeValid(string $num): bool
    {
        if (strlen($num) == 18) {
     ...
     */
    public function hideCard(string $idCard): string
    {
        if (empty($idCard)) {
            return $idCard;
        }
